...
import LogoContainer from "../ReUsableComponent/LogoContainer/LogoContainer";
    ...
    <div className="min-h-screen bg-black text-white font-sans overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 sm:py-3 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-4 lg:gap-8 text-sm font-medium">
            {["Features", "How It Works", "Pricing"].map((item, index) => (
              <motion.a
                ...
                whileHover={{ scale: 1.1, color: "#E54FA9" }}
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <motion.div
              ...
              className="text-xs sm:text-sm font-medium hover:text-[#E54FA9] transition-colors whitespace-nowrap"
            >
            ...
            <motion.div
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-[#E54FA9] to-[#831CDF] hover:from-[#D63F99] hover:to-[#730CCF] px-3 sm:px-5 py-1.5 sm:py-2.5 rounded-full text-xs sm:text-sm font-semibold transition-colors whitespace-nowrap"
            >
      ...
      <main className="pt-24 sm:pt-20 md:pt-24 pb-12 sm:pb-16 md:pb-20 lg:pb-4  relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <div className="flex-1 text-center pt-8 lg:text-left w-full">
              ...
              <motion.div 
                variants={fadeInUp}
                className="inline-block mb-3 sm:mb-4 md:mb-6 px-3 sm:px-5  py-1.5 sm:py-2 bg-zinc-900/70 border border-zinc-700 rounded-full text-xs sm:text-sm font-medium tracking-wide text-[#E54FA9]"
              >
              ...
              >
                ...
                Meets <span className="bg-gradient-to-r from-[#E54FA9] to-[#831CDF] bg-clip-text text-transparent">Vision</span>.
              </motion.h1>
              ...
              >
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="bg-gradient-to-r from-[#E54FA9] to-[#831CDF] hover:from-[#D63F99] hover:to-[#730CCF] px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 rounded-lg sm:rounded-xl text-sm sm:text-base font-bold transition-all shadow-lg shadow-[#831CDF]/30 w-full xs:w-auto"
                >
                  Join as Creative
                </motion.a>
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="border border-[#E54FA9] text-[#E54FA9] hover:bg-[#E54FA9]/10 px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 rounded-lg sm:rounded-xl text-sm sm:text-base font-bold transition-all w-full xs:w-auto"
                >
                  Join as Industry
                </motion.a>
              </motion.div>
            ...
            >
              ...
              <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-20 left-10 w-40 xl:w-48 2xl:w-64 h-40 xl:h-48 2xl:h-64 bg-[#E54FA9]/10 rounded-full blur-3xl" />
                <div className="absolute bottom-10 right-10 w-48 xl:w-56 2xl:w-72 h-48 xl:h-56 2xl:h-72 bg-[#831CDF]/10 rounded-full blur-3xl" />
              </div>
                ...
                <div className="p-3 xl:p-4 2xl:p-5">
                  <div className="flex items-center gap-2 xl:gap-3 mb-2 xl:mb-3">
                    <div className="relative">
                      <div className="w-8 xl:w-9 2xl:w-10 h-8 xl:h-9 2xl:h-10 rounded-full bg-gradient-to-br from-[#E54FA9] to-[#831CDF] flex items-center justify-center shadow-lg shadow-[#831CDF]/40">
                    ...
                    <div>
                      ...
                      <span className="inline-block px-1.5 xl:px-2 py-0.5 mt-0.5 text-[10px] xl:text-xs font-semibold text-[#E54FA9] bg-[#E54FA9]/20 rounded-full">
                        Songwriter
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="mb-2 xl:mb-3">
                    <div className="relative h-1 bg-zinc-800 rounded-full overflow-hidden">
                      <motion.div 
                        ...
                        className="absolute h-full bg-gradient-to-r from-[#E54FA9] to-[#831CDF] rounded-full"
                      />
                    </div>
                  ...
                  <div className="flex gap-1">
                    <span className="px-1.5 xl:px-2 py-0.5 text-[10px] xl:text-xs font-medium bg-[#831CDF]/20 text-[#E54FA9] rounded-full border border-[#831CDF]/40">
                      Hip Hop
                    </span>
                    <span className="px-1.5 xl:px-2 py-0.5 text-[10px] xl:text-xs font-medium bg-[#831CDF]/20 text-[#E54FA9] rounded-full border border-[#831CDF]/40">
                      R&B
              ...
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 300 }}
                className="absolute inset-0 m-auto w-[240px] xl:w-[280px] 2xl:w-[320px] bg-gradient-to-br from-zinc-950 to-black border border-zinc-700/90 rounded-2xl overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.9),0_0_30px_rgba(131,28,223,0.15)] backdrop-blur-md transform rotate-[4deg] translate-x-[10%] translate-y-[-5%] z-20"
              >
                <div className="p-3 xl:p-4 2xl:p-5">
                  <div className="flex items-center gap-2 xl:gap-3 mb-2 xl:mb-3">
                    <div className="relative">
                      <div className="w-9 xl:w-10 2xl:w-12 h-9 xl:h-10 2xl:h-12 rounded-full bg-gradient-to-br from-[#E54FA9] to-[#831CDF] flex items-center justify-center shadow-lg shadow-[#831CDF]/50 ring-2 ring-[#E54FA9]/30">
                    ...
                    <div>
                      ...
                      <span className="inline-block px-1.5 xl:px-2 py-0.5 mt-0.5 text-[10px] xl:text-xs font-semibold text-[#831CDF] bg-[#831CDF]/20 rounded-full">
                        Producer
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-1 mb-3 xl:mb-4">
                    <span className="px-1.5 xl:px-2 py-0.5 xl:py-1 text-[10px] xl:text-xs font-medium bg-[#831CDF]/30 text-[#E54FA9] rounded-full border border-[#831CDF]/50">
                      Hip Hop
                    </span>
                    <span className="px-1.5 xl:px-2 py-0.5 xl:py-1 text-[10px] xl:text-xs font-medium bg-[#831CDF]/30 text-[#E54FA9] rounded-full border border-[#831CDF]/50">
                      R&B
                  ...
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="w-full py-1.5 xl:py-2 2xl:py-2.5 px-3 xl:px-4 bg-gradient-to-r from-[#E54FA9] to-[#831CDF] hover:from-[#D63F99] hover:to-[#730CCF] text-white font-semibold rounded-lg xl:rounded-xl shadow-lg shadow-[#831CDF]/40 transition-all duration-300 active:scale-95 text-[10px] xl:text-xs 2xl:text-sm"
                  >
                    Connect
                  </motion.button>
                </div>
        ...
        <div className="absolute inset-0 pointer-events-none">
          <motion.div 
            ...
            className="absolute top-1/4 left-1/4 w-32 xs:w-40 sm:w-48 md:w-64 lg:w-80 xl:w-96 h-32 xs:h-40 sm:h-48 md:h-64 lg:h-80 xl:h-96 bg-[#E54FA9]/10 rounded-full blur-3xl"
          />
          <motion.div 
            animate={{ 
              scale: [1, 1.3, 1],
            ...
            className="absolute bottom-1/4 right-1/4 w-32 xs:w-40 sm:w-48 md:w-64 lg:w-80 xl:w-96 h-32 xs:h-40 sm:h-48 md:h-64 lg:h-80 xl:h-96 bg-[#831CDF]/10 rounded-full blur-3xl"
          />
        </div>
      </main>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div variants={fadeInUp} className="text-center mb-6 xs:mb-8 sm:mb-12 md:mb-16 lg:mb-20">
            <h2 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black tracking-tight mb-2 sm:mb-3 md:mb-4">
              <span className="bg-gradient-to-r from-[#E54FA9] to-[#831CDF] bg-clip-text text-transparent">Features</span> That Matter
            </h2>
          ...
          <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-3 xs:gap-4 sm:gap-5 md:gap-6 lg:gap-8">
            {[
              ...
              <motion.div
                key={index}
                variants={fadeInUp}
                whileHover={{ scale: 1.03, borderColor: "#E54FA9" }}
                transition={{ type: "spring", stiffness: 300 }}
                className="bg-zinc-950/80 border border-zinc-800 rounded-lg xs:rounded-xl sm:rounded-2xl p-4 xs:p-5 sm:p-6 md:p-8 hover:border-[#E54FA9]/50 transition-all"
              >
                <motion.div 
                ...
                >
                  <card.icon className="w-4 xs:w-5 sm:w-6 md:w-7 lg:w-8 xl:w-10 h-4 xs:h-5 sm:h-6 md:h-7 lg:h-8 xl:h-10 bg-gradient-to-r from-[#E54FA9] to-[#831CDF] bg-clip-text text-transparent" style={{ fill: 'url(#gradient)' }} />
                </motion.div>
                ...
                <ul className="space-y-1 xs:space-y-1.5 sm:space-y-2 md:space-y-3 text-xs xs:text-sm sm:text-base text-zinc-300">
                  {card.items.map((item, i) => (
                    ...
                    >
                      <CheckCircle className="w-3 xs:w-3.5 sm:w-4 h-3 xs:h-3.5 sm:h-4 bg-gradient-to-r from-[#E54FA9] to-[#831CDF] bg-clip-text text-transparent flex-shrink-0" style={{ fill: 'url(#gradient)' }} />
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div variants={fadeInUp} className="text-center mb-6 xs:mb-8 sm:mb-12 md:mb-16 lg:mb-20">
            <h2 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black tracking-tight mb-2 sm:mb-3 md:mb-4">
              How <span className="bg-gradient-to-r from-[#E54FA9] to-[#831CDF] bg-clip-text text-transparent">SPARTST</span> Works
            </h2>
            <p className="text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-zinc-400 font-medium px-2 sm:px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 xs:gap-4 sm:gap-5 md:gap-6 lg:gap-8 mb-8 xs:mb-10 sm:mb-12 md:mb-16 lg:mb-20 xl:mb-24">
            {[
              { number: "01", icon: Sparkles, title: "Create Your Lookbook", desc: "Showcase your best work in a professional, curated portfolio designed for industry viewing.", color: "from-[#E54FA9] to-[#831CDF]" },
              { number: "02", icon: Search, title: "Discover & Connect", desc: "Use AI-powered matching to find collaborators that fit your specific style, genre, and goals.", color: "from-[#831CDF] to-[#E54FA9]" },
              { number: "03", icon: Briefcase, title: "Collaborate & Earn", desc: "Manage projects, split sheets, and agreements securely within our workspace.", color: "from-[#E54FA9] to-[#831CDF]" }
            ].map((step, index) => (
              <motion.div
                key={index}
                variants={fadeInUp}
                ...
                transition={{ type: "spring", stiffness: 300 }}
                className={`bg-zinc-950/70 border border-zinc-800 rounded-lg xs:rounded-xl sm:rounded-2xl p-4 xs:p-5 sm:p-6 md:p-8 lg:p-10 hover:border-[#E54FA9]/50 transition-all duration-300 group ${
                  index === 1 ? 'sm:col-span-2 lg:col-span-1' : ''
                }`}
              >
                <div className="flex items-center justify-between mb-2 xs:mb-3 sm:mb-4 md:mb-5 lg:mb-6">
                  <div className={`w-6 xs:w-7 sm:w-8 md:w-10 lg:w-12 xl:w-14 h-6 xs:h-7 sm:h-8 md:h-10 lg:h-12 xl:h-14 rounded-lg xs:rounded-xl bg-gradient-to-br ${step.color} bg-opacity-20 flex items-center justify-center text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-black text-white`}>
                    {step.number}
                  </div>
                  <motion.div 
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.6 }}
                    className={`w-5 xs:w-6 sm:w-7 md:w-8 lg:w-10 xl:w-12 h-5 xs:h-6 sm:h-7 md:h-8 lg:h-10 xl:h-12 rounded-full bg-gradient-to-br ${step.color} bg-opacity-20 flex items-center justify-center`}
                  >
                    <step.icon className={`w-3 xs:w-3.5 sm:w-4 md:w-5 lg:w-6 xl:w-8 h-3 xs:h-3.5 sm:h-4 md:h-5 lg:h-6 xl:h-8 bg-gradient-to-r ${step.color} bg-clip-text text-transparent`} />
                  </motion.div>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div variants={fadeInUp} className="text-center mb-6 xs:mb-8 sm:mb-12 md:mb-16 lg:mb-20">
            <h1 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black tracking-tight mb-2 sm:mb-3 md:mb-4">
              Simple, <span className="bg-gradient-to-r from-[#E54FA9] to-[#831CDF] bg-clip-text text-transparent">Transparent</span> Pricing
            </h1>
            ...
            {[
              ...
              <motion.div
                ...
                className={`relative bg-zinc-950/70 border ${
                  plan.popular 
                    ? 'border-2 border-[#E54FA9]/50 shadow-2xl shadow-[#831CDF]/30 md:scale-105 lg:scale-105 xl:scale-110 z-10 hover:border-[#E54FA9]' 
                    : 'border-zinc-800 hover:border-[#E54FA9]/30'
              ...
              >
                {plan.popular && (
                  <motion.div
                    ...
                    className="absolute -top-2 xs:-top-2.5 sm:-top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-[#E54FA9] to-[#831CDF] text-white text-[10px] xs:text-xs font-bold px-2 xs:px-3 sm:px-4 py-0.5 xs:py-1 rounded-full uppercase tracking-wide shadow-lg whitespace-nowrap"
                  >
                    Most Popular
                  </motion.div>
                )}
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <plan.icon className={`w-5 xs:w-6 sm:w-7 md:w-8 h-5 xs:h-6 sm:h-7 md:h-8 bg-gradient-to-r from-[#E54FA9] to-[#831CDF] bg-clip-text text-transparent`} />
                </div>
                ...
                <motion.button
                  ...
                  className={`mt-auto flex items-center justify-center gap-1 sm:gap-2 ${
                    plan.popular 
                      ? 'bg-gradient-to-r from-[#E54FA9] to-[#831CDF] hover:from-[#D63F99] hover:to-[#730CCF] shadow-lg shadow-[#831CDF]/40' 
                      : 'border border-[#E54FA9]/30 hover:bg-[#E54FA9]/10'
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 xs:gap-5 sm:gap-6 md:gap-8 lg:gap-10 text-[10px] xs:text-xs sm:text-sm text-zinc-400">
          <div className="col-span-2 sm:col-span-3 md:col-span-1">
            ...
            <p className="leading-relaxed text-[10px] xs:text-xs flex items-center gap-1">
              <Globe className="w-3 h-3 inline-block bg-gradient-to-r from-[#E54FA9] to-[#831CDF] bg-clip-text text-transparent" />
                ...
                {section.links.map((link, i) => (
                  ...
                  >
                    <a 
                      ...
                      className="hover:text-white transition text-[8px] xs:text-[10px] sm:text-xs flex items-center gap-1 group"
                    >
                      <ChevronRight className="w-2 h-2 opacity-0 group-hover:opacity-100 transition-opacity bg-gradient-to-r from-[#E54FA9] to-[#831CDF] bg-clip-text text-transparent" />
                      {link}
                    </a>
                  </motion.li>
                ))}
